// app/login/page.jsx (or app/signup/page.jsx)
"use client";
      ...
      <div className="max-w-md w-full space-y-8">
        <form className="space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-800 focus:outline-none"
            >
              Sign up
            </button>
          </div>
